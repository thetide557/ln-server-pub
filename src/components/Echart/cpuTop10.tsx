...
export default function CpuTop10() {
        ...
        series: [
            {
                ...
                itemStyle: {
                    ...
                    color: new echarts.graphic.LinearGradient(
                        0, 0, 1, 1,
                        [
                            { offset: 0, color: '#FDFDFF' },
                            { offset: 1, color: '#4E84FF' }
                        ]
                    )
                },
                data: []
    ...
    useEffect(() => {
        ...
        const getData = (() => {
            ...
            fetchHistoryInstantBatch({
                datasource_id: 1, queries: [{ time: start, query: "topk(10,cpu_usage_active{cpu=\"cpu-total\"} )" }]
            }, 22).then((res) => {
