...
export default function index(props: Props) {
  ...
  // step6f（ES 升级轮）：fe v9.1.0 的 ICommonState 里有 darkMode（暗色模式开关），
  // 羚牛 pub 的 ICommonState 没有这个字段（pub `src/App.tsx:73-108`），按纪律 pub 现有共享文件不许动，
  // 这里加 `as any` 取一下：pub 上取不到就是 undefined，等于一直用亮色主题，和 pub 现在的表现一致。已登记。
