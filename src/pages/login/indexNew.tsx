            ...
            </div>
            {
              toggle ? (
                ...
                <Form form={form} layout='vertical' className='login_form' requiredMark={true}>
                  ...
                  >
                    <Input type='password' placeholder={t('请输入密码')} onPressEnter={() => handleSubmit('ladp')} prefix={<LockTwoTone className='site-form-item-icon' />} />
                  </Form.Item>
                  ...
                  <div className='verifyimg-div'>
                    <Form.Item
                      ...
                      hidden={!showcaptcha}
                    >
                      <Input className='code1' placeholder={t('请输入验证码')} onPressEnter={() => handleSubmit('ladp')} prefix={<SafetyCertificateTwoTone className='site-form-item-icon' />} />
                    </Form.Item>
                    <img className='img11'
                      ref={verifyimgRef}
                      style={{
                  ...
                  <Form.Item className='form-remeber' name="rememberLdap" valuePropName='checked' wrapperCol={{ offset: 0, span: 24 }}>
                    <Checkbox onChange={(event) => handleRememberChange('ladp', event)}>记住密码</Checkbox>
                  </Form.Item>

                  <Form.Item>
                    <Button loading={loadingLdap} type='primary' className='submit_button' onClick={() => handleSubmit('ladp')} onKeyPress={e => {
                      handleSubmit('ladp')
                    }}>
                      {t('登录')}
                    </Button>
