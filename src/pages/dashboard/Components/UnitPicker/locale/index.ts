...
// 命名空间 unitPicker，与 fe 原文件里 resources 的键一字不差。
import i18next from 'i18next';
import en_US from './en_US';
import zh_CN from './zh_CN';
import zh_HK from './zh_HK';

i18next.addResourceBundle('en_US', 'unitPicker', en_US);
i18next.addResourceBundle('zh_CN', 'unitPicker', zh_CN);
i18next.addResourceBundle('zh_HK', 'unitPicker', zh_HK);
