...
// 第六步 第4段 W1-时序组：fe 原文没有引 lodash，这里为了 _.omit(field, 'key') 补上（写法同 TDengine / ck）。
import _ from 'lodash';
import { Form } from 'antd';
import Queries from './Queries';
import Triggers from '@/pages/alertRules/FormNG/components/Triggers';

// 第六步 第4段 W1-时序组：把这个编辑器接进羚牛的多策略告警表单。
...
//
// 两条规矩（出处：第六步-流水线/第4段/顾问问答-大顾问.md Q1 第二节；做法与阶段 0 的 ck 样板逐字同构）：
//   规矩 A · 按调用种类分路径：
...
export default function IotDBAlertRule({ datasourceValue, field, cate, disabled }: IProps) {
