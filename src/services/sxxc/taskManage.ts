...
export function getBizScriptList(params) {
    return request(`/sxxc/biz/task/script/list`, {
...
export function addBizScript (data: any) {
    return request(`/sxxc/biz/task/script/add`, {
...
export function removeBizScript (ids: any) {
    return request(`/sxxc/biz/task/script/remove/${ids}`, {
      method: RequestMethod.Post,
    });
};
// 修改任务
export function editBizScript (data: any) {
    return request(`/sxxc/biz/task/script/edit`, {
      method: RequestMethod.Post,
      data,
    });
};
...
export function getBizScriptInfo(id:any) {
    return request(`/sxxc/biz/task/script/${id}`, {
        method: RequestMethod.Get
    });
}
// 执行任务
export function runTask (data: any) {
    return request(`/sxxc/biz/task/task/excutor/run`, {
      method: RequestMethod.Post,
      data,
    });
};
...
export function getTaskLog(params) {
    return request(`/sxxc/biz/task/task/excutor/getLog`, {
        method: RequestMethod.Get,
        params,
    });
}
...
export function getTaskLogList(params) {
    return request(`/sxxc/biz/task/task/log/list`, {
        method: RequestMethod.Get,
        params,
    });
}
...
export function getTaskLogInfo(id) {
    return request(`/sxxc/biz/task/task/log/${id}`, {
        method: RequestMethod.Get,
    });
}
// 查看任务类型
export function getTaskTypeList(params) {
    return request(`/sxxc/biz/task/task/type/list`, {
        method: RequestMethod.Get,
        params,
    });
}
