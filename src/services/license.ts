...
export const getLicense = function (params={}) {
    return request(`/api/takin/xh/license-config`, {
...
export const saveCertificate = function (data:any) {
  return request('/api/takin/xh/license/add-file', {
    method: RequestMethod.Post,
    data
  });
};
...
export const updateCertificate = function (data:any) {
  return request('/api/takin/xh/license/update', {
    method: RequestMethod.Put,
    data
  });
};
...
export const getCertificate = function (params={}) {
  return request(`/api/takin/xh/license/list`, {
    method: RequestMethod.Get,
    params,
  });
};
