...
export const getSubscribeList = function (params: { id: number }) {
  return request(`/api/takin/busi-group/${params.id}/alert-subscribes`, {
    method: RequestMethod.Get
  });
};

export const getSubscribeData = function (subscribeId: number) {
  return request(`/api/takin/alert-subscribe/${subscribeId}`, {
    method: RequestMethod.Get
  });
};

export const addSubscribe = function (data: any, busiId: number) {
  return request(`/api/takin/busi-group/${busiId}/alert-subscribes`, {
